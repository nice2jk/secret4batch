...
def batch():
    ...
    schedule.every(241).minutes.do(newspp, dbWrite)
    ...
    # schedule.every(7).seconds.do(bestit, dbWrite)
    # schedule.every(10).seconds.do(xartpd, dbWrite)
    # schedule.every(2).seconds.do(xartbb, dbWrite)
    # schedule.every(4).seconds.do(soccfm, dbWrite)
    # schedule.every(6).seconds.do(baseml, dbWrite)
    # schedule.every(8).seconds.do(basekb, dbWrite)
    # schedule.every(11).seconds.do(moviex, dbWrite)
    # schedule.every(6).seconds.do(girlpn, dbWrite)
    # schedule.every(3).seconds.do(girl82, dbWrite)
